...
(** To save space in the discussion, let's go back to an
    ...
    Plus) -- as constructor names, for brevity(short).)  At the end of the
...
(* SOONER : Leo: Why isn't this three? (See below) *)
...
(** **** Exercise: 1 star, standard (test_multistep_3)  *)
...
(** **** Exercise: 2 stars, standard, optional (multistep_congr_2)  *)
...
Proof.
  ...
  rewrite nf_same_as_value in H1.
  - inversion H1. exists n. split. reflexivity. constructor.
  - destruct IHmulti.
    * split. apply H2. apply H1.
    * apply H1.
    * exists x0. split.
      + apply H3.
      + eapply step__eval. apply H0. apply H3.
Qed.
(** [] *)
...
(** **** Exercise: 4 stars, standard, optional (combined_properties) 
